                        ...
                        if (dataSet.Tables[0].Rows[0]["Activated"].ToString() == "1")
                        {
                            ...
                            if (dictionary.Count != 0)
                            {
                                ...
                                if (dltDetails.Item1)
                                {
                                    ...
                                    {
                                        importnum.ImportInvalidRequest(userId, username, messageid, senderid, message, DateTime.Now.ToString("yyyyMMddHHmmss"), mobileno, "INVALID PE ID.", isUnicode ? "2" : "");
                                ...
                                {
                                    importnum.ImportInvalidRequest(userId, username, messageid, senderid, message, DateTime.Now.ToString("yyyyMMddHHmmss"), mobileno, "INVALID SENDER ID.", isUnicode ? "2" : "");
